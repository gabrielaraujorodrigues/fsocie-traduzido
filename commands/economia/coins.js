...
export default {
  name: "dolares",
  command: ["dolares", "saldo", "usd", "dinheiro", "coins", "balance", "wallet", "cartera", "misdolares"],
  category: "economia",
  description: "Mostra tus dolares, solicitudes e inventario",
    ...
    await sock.sendMessage(
      from,
      {
        text:
          ...
          `Número: *${formatUserPhone(sender) || "Sin número visible"}*\n` +
          ...
          `Cobro de downloads: *${esDono ? "EXENTO OWNER" : config.downloadBillingEnabled ? "ACTIVO" : "APAGADO"}*\n\n` +
