      ...
      await sock.sendMessage(
        from,
        {
          text:
            ...
            "Reinicio rapidamente sin desligar el proceso.\n" +
        ...
        return sock.sendMessage(
          from,
          {
            text:
              ...
              "Si persiste, use `.restart full` para reinicio completo del proceso.",
            ...global.channelInfo,
          },
          { quoted: msg }
        );
      ...
      return sock.sendMessage(
        from,
        {
          text:
            `*RESTART BLOQUEADO*\n\n` +
            `Entorno: *${restartMode.label}*\n` +
            "Reinicia desde painel, PM2 o consola cuando quieras recargar el bot.",
          ...global.channelInfo,
        },
        { quoted: msg }
      );
    ...
    await sock.sendMessage(
      from,
      {
        text:
          ...
          "Tip: use `.restart` sin argumentos para reinicio suave (mas estable).",
        ...global.channelInfo,
      },
      { quoted: msg }
    );
