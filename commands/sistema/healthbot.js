...
export default {
  ...
  run: async ({ sock, msg, from, settings }) => {
    ...
    const statusText =
      ...
      `│ Tempo ativo: *${formatDuration(uptimeMs)}*\n` +
      ...
      `╰────────────⬣\n\n` +
      `Tip: use *${prefix}antierro on* para ver erroes limpios en chat.`;
    ...
    return sock.sendMessage(
      from,
      {
        ...
        footer: "Pressione para refrescar",
        interactiveButtons: [
          {
            name: "single_select",
              ...
              sections: [
                {
                  ...
                  rows: [
                    ...
                    {
                      header: "CONTROL",
                      title: "Abrir painel admin de grupo",
                      description: "Gestãoa antilink, antispam y mas.",
                      id: `${prefix}gpainel`,
                    },
                  ],
                },
