...
function mimeFromFileName(fileName) {
  ...
  if (lower.endsWith(".mp3")) return "áudio/mpeg";
  if (lower.endsWith(".mp4")) return "vídeo/mp4";
    ...
    try {
      ...
      if (!fileUrl) {
        ...
        return sock.sendMessage(
          ...
          {
            text:
              "Uso: .mega <link publico de MEGA> o responda a un mensagem con el link\n" +
              "Nota: por ahora solo sirve para links de archivo, no carpetas.",
            ...global.channelInfo,
          },
          quoted
        );
      ...
      await sock.sendMessage(
        from,
        {
          text: sanitizeProviderMessage(erro, { kind: "file", fallback: "No se pudo procesar el archivo de MEGA." }),
          ...global.channelInfo,
        },
        quoted
      );
