...
export default {
  ...
  category: "download",
  description: "Download archivos públicos de MediaFire",
    ...
    try {
      ...
      await sock.sendMessage(
        from,
        {
          text: [
            "╭━━〔 *❌ MEDIAFIRE ERROR* 〕━━⬣",
            `┃ ${sanitizeProviderMessage(erro, { kind: "file", fallback: "No se pudo procesar el archivo de MediaFire." })}`,
            "╰━━━━━━━━━━━━━━━━━━⬣",
          ].join("\n"),
          ...global.channelInfo,
        },
