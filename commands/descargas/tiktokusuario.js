import { searchTikTokVídeosByUser } from "./_searchFallbacks.js";
...
export default {
  ...
  category: "busca",
  description: "Busca vídeos de un usuário especifico en TikTok",
  ...
  run: async (ctx) => {
    ...
    try {
      const results = await searchTikTokVídeosByUser(username, 3);

      if (!results.length) {
        return sock.sendMessage(
          from,
          {
            text: "No encontre vídeos de ese usuário especifico.",
            ...global.channelInfo,
          },
          { quoted: msg }
        );
      ...
      await sock.sendMessage(
        from,
        {
          text: "Erro obteniendo los vídeos del usuário.",
          ...global.channelInfo,
        },
        { quoted: msg }
      );
