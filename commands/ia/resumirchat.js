...
export default {
  name: "resumirchat",
  command: ["resumirchat", "chatresumo", "resumochat"],
  category: "ia",
  description: "Resume conversacion reciente del grupo con analisis rapidamente",
  groupOnly: true,
  ...
  run: async ({ sock, msg, from, args = [], settings }) => {
    ...
    return sock.sendMessage(
      from,
      {
        text:
          `╭━━━〔 🧠 RESUMEN DE CHAT 〕━━━⬣\n` +
          `┃ Mensagems analizados: *${summary.count}*\n` +
          `┃ Rango: *${summary.range}*\n` +
          `╰━━━━━━━━━━━━━━━━━━━━━━⬣\n\n` +
          `👥 *Mas ativos*\n${participantText}\n\n` +
          `🏷️ *Temas detectados*\n${keywordText}\n\n` +
