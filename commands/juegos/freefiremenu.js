    ...
    const sections = [
      {
        ...
        rows: [
          { header: "Painel", title: "Abrir painel de evento", description: "Inscripciones por botones", id: `${prefix}evento` },
          { header: "Plantilla", title: "Crear evento Free Fire", description: "Torneo FF 4v4 listo", id: `${prefix}evento crear ff` },
          { header: "Inscripcion", title: "Unirme al evento", description: "Registro automático con tu número", id: `${prefix}evento unir` },
      ...
      },
      {
        title: "Torneo",
        rows: [
          { header: "Crear", title: "Crear torneo", description: "Novo torneo FF", id: `${prefix}ffcrear Torneo Semanal` },
      ...
      },
      {
        ...
        rows: [
          ...
          { header: "Estado", title: "Estado torneo", description: "Resumo general", id: `${prefix}ffestado` },
