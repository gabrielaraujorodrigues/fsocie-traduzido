...
export const TRIVIA_QUESTIONS = [
  ...
  {
    question: "Que comando mostra el estado de las APIs del bot?",
    options: ["apiestado", "exploit", "crashhost", "superpainel"],
    answer: 1,
  },
  {
  ...
  {
    question: "Que red use el bot para conectarse?",
  ...
  {
    question: "Quien use el Sharingan en Naruto?",
  ...
  {
    question: "Cual de estos es un comando novo del bot?",
...
export const EMOJI_QUIZZES = [
  ...
  { emojis: "⬇️ 🎬", answer: "downloadr vídeo" },
  { emojis: "🎧 🎶", answer: "spotify" },
  { emojis: "📸 ❤️", answer: "instagram" },
  { emojis: "🕹️ 👑", answer: "rey del jogo" },
];
...
export const TRUE_FALSE_QUESTIONS = [
  ...
  {
    statement: "El comando .status mostra el estado del bot.",
    answer: true,
    explanation: "Status es el comando pensado para revisar el estado del bot.",
  },
  {
    statement: "Sasuke use el Sharingan.",
    answer: true,
