...
export default {
  ...
  category: "grupo",
  description: "Guarda y mostra regras do grupo",
  groupOnly: true,
  ...
  run: async ({ sock, msg, from, args = [], settings, esDono, esAdmin }) => {
    ...
    if (!esDono && !esAdmin) {
      return sock.sendMessage(from, { text: "Solo admins u owner pueden cambiar las regras.", ...global.channelInfo }, { quoted: msg });
    }
    ...
    if (action === "set") {
      ...
      store.scheduleSave();
      return sock.sendMessage(from, { text: "Regras actualizadas.", ...global.channelInfo }, { quoted: msg });
    }
