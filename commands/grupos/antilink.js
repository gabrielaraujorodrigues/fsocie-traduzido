...
function parseToggle(value = "") {
  ...
  if (["on", "ativar", "bloquear", "1", "si"].includes(normalized)) return true;
...
function resolveFilterTarget(value = "") {
  ...
  if (["youtube", "yt", "youtubelinks", "vídeosyt"].includes(normalized)) {
    return "youtube";
  }
  if (["otros", "other", "others", "externos", "links", "links"].includes(normalized)) {
    return "others";
  }
  return "";
}
...
export default {
  ...
  async run({ sock, from, args = [], msg, settings }) {
      ...
      return sock.sendMessage(
        from,
        {
          text:
            ...
            `Otros links: *${formatToggle(config.blockOtherLinks)}*\n` +
          ...
          footer: "Selecione desde el painel para cambiar rapidamente",
          interactiveButtons: [
            {
              name: "single_select",
              buttonParamsJson: JSON.stringify({
                title: "Painel AntiLink",
                sections: [
                  {
                    ...
                    rows: [
                      {
                        ...
                        description: "Enciende proteccion de links.",
                        id: `${prefix}antilink on`,
                      },
                      {
                        header: "OFF",
                        title: "Desativar AntiLink",
                        description: "Apaga proteccion de links.",
                  ...
                  },
                  {
                    ...
                    rows: [
                      {
                        header: "DELETE",
                        title: "Modo borrar mensagem",
                        description: "Borra el mensagem con link.",
                    ...
                    rows: [
                      {
                        ...
                        title: config.blockWhatsappGroups
                          ? "Permitir links de grupos WhatsApp"
                          : "Bloquear links de grupos WhatsApp",
                      ...
                      },
                      {
                        ...
                        title: config.blockWhatsappChannels
                          ? "Permitir links de canales WhatsApp"
                          : "Bloquear links de canales WhatsApp",
                      ...
                      },
                      {
                        ...
                        title: config.blockYoutubeLinks
                          ? "Permitir links de YouTube"
                          : "Bloquear links de YouTube",
                      ...
                      },
                      {
                        ...
                        title: config.blockOtherLinks
                          ? "Permitir otros links"
                          : "Bloquear otros links",
    ...
    if (action === "on") {
      if (commandStartsYoutube) {
        ...
        return sock.sendMessage(
          from,
          {
            text: "AntiLink YouTube ativado. Ahora avisara 3 veces antes de expulsar.",
            ...global.channelInfo,
          },
          quoted
        );
    ...
    if (action === "allow") {
      ...
      if (target === "whatsapp" || target === "wa") {
        ...
        return sock.sendMessage(
          from,
          {
            text: "Los links de WhatsApp (grupos y canales) quedaron permitidos.",
            ...global.channelInfo,
          },
          quoted
        );
    ...
    if (action === "deny") {
      ...
      if (target === "whatsapp" || target === "wa") {
        ...
        return sock.sendMessage(
          from,
          {
            text: "Los links de WhatsApp (grupos y canales) quedaron bloqueados.",
            ...global.channelInfo,
          },
          quoted
        );
    ...
    if (action === "tipo" || action === "filtro" || action === "filtros") {
      ...
      return sock.sendMessage(
        from,
        {
          text: `Otros links: *${formatToggle(config.blockOtherLinks)}*`,
          ...global.channelInfo,
        },
        quoted
      );
            ...
            (entries.length
              ? entries
                  .map((entry, index) => {
                    ...
                    const linkText = String(entry?.link || entry?.domain || "sin link");
    ...
    return sock.sendMessage(
      from,
      {
        text: "Opção inválida. Use .antilink status para ver la ajuda.",
        ...global.channelInfo,
      },
      quoted
    );
  ...
  async onMessage({ sock, msg, from, esGrupo, esAdmin, esDono, esBotAdmin, groupMetadata }) {
    ...
    const texto =
      ...
      msg.message?.vídeoMessage?.caption;
      ...
      try {
        ...
        await sock.sendMessage(from, {
          text:
            ...
            `🔗 Link bloqueado: *${blockedLink.domain || blockedLink.raw}*\n` +
    ...
    if (config.mode === "kick") {
      ...
      await sock.sendMessage(from, {
        text:
          ...
          `${mentionText}, no envies este tipo de link.\n` +
