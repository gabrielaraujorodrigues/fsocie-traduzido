...
export default {
  ...
  command: ["subbotvip"],
  category: "admin",
  description: "Crea subbot VIP sin limite de tempo y administra VIP especial",
        ...
        return sock.sendMessage(
          from,
          {
            text:
              ...
              `Solo el owner o el número principal del bot pueden pedir subbot VIP.\n` +
