...
export default {
  ...
  category: "admin",
  description: "Bloquea o desbloquea usuários del bot",
    ...
    if (normalizedCommand === "unbanuser") {
      ...
      if (!target.number) {
        return sock.sendMessage(
          from,
          {
            text: `Usa: *${prefix}unbanuser 519xxxxxxx* o responda al usuário.`,
            ...global.channelInfo,
          },
          getQuoted(msg)
        );
      ...
      return sock.sendMessage(
        from,
        {
          text:
            ...
            `o responda al usuário para bloquearlo.`,
          ...global.channelInfo,
        },
        getQuoted(msg)
      );
